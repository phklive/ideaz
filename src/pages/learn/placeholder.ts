...
const questions: Question[] = [
  ...
  {
    question: "How many dollars were stolen from The DAO Hack (in millions)?",
    answers: ["50"],
    wrongAnswers: ["100", "200", "250"],
  },
  {
    ...
    wrongAnswers: ["Proof of Stake", "Proof of Authority", "Proof of Space"],
  },
  {
    question: "Which type of consensus is used in Tezos?",
    answers: ["Liquid Proof-of-Stake"],
    wrongAnswers: [
      "Delegated Proof-of-Stake",
      "Proof-of-Stake",
      "Absolute Proof-of-Stake",
    ],
  },
];

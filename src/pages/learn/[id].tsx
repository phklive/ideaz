        ...
        {activeQuestion === -1 ? (
          ...
          <div className="flex flex-col items-center justify-center h-screen w-screen gap-16">
            <div className="flex flex-col justify-center items-center">
              ...
              <a href={course.docURL} className="flex flex-row mt-4">
                Documentation <AiOutlineLink />
              </a>
            </div>
            <div className="flex flex-col items-center justify-center w-full">
              ...
              <div className="flex flex-row gap-2">
                ...
                <button
                  ...
                  className="rounded bg-gray-50 px-3 py-1 mx-auto my-8"
                >
                  {activeQuestion == course.questions.length - 1
                    ? "Validate answers"
                    : "Next question"}
                </button>
              </div>
          ...
          {valid ? (
            <div className="flex flex-col items-center justify-center">
              ...
              <span className="text-center">
                Congratulation you pass the certification for the {course.name}{" "}
                course!
              </span>
              <span>
                Get the certification proof by taking the {course.name} NFT
              </span>
              <Image src="/blockchain_basics.png" width={226} height={226} />
              <button
                onClick={() => console.log("transaction pending...")}
                className="rounded bg-gray-50 px-3 py-1 mx-auto mb-4 bg-blue-300"
              >
                Take it
              </button>
            </div>
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <span className="text-center">
                You need to pass the questions perfectly to get the
                certification proof.
              </span>
            </div>
          )}
